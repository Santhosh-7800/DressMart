...
import type { ProductStatus, AdminProductInput } from '@/types';
...
export function useCreateProduct() {
  ...
  return useMutation({
    mutationFn: ({ sellerId, sellerName, input, actor }: { sellerId: string; sellerName: string; input: AdminProductInput; actor?: { id: string; name: string } }) =>
...
export function useUpdateProduct() {
  ...
  return useMutation({
    mutationFn: ({
      ...
      input,
      actor,
    }: { productId: string; sellerId: string; sellerName: string; input: AdminProductInput; actor?: { id: string; name: string } }) =>
