...
export function AdminExchangesPage() {
  ...
  const orderFor = useMemo(() => {
    ...
    return (e: ExchangeRequest) => byOrderId.get(e.order_id);
  }, [orders]);
  const itemFor = (e: ExchangeRequest): OrderItem | undefined => orderFor(e)?.items.find((i) => i.id === e.order_item_id);
