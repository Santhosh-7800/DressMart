...
/** A delivery account's own profile — mirrors StaffProfilePage.tsx exactly: identity/appearance/
 *  password only. No Danger Zone (account deletion is Head-Seller-only, via removeDeliveryStaff). */
    ...
    <div className="space-y-6">
      ...
      <Card hover={false}>
        ...
        <div className="mt-4 flex items-center justify-between border-t border-acc-border pt-3 text-sm dark:border-primary-700">
          ...
          <span className="font-medium text-acc-text dark:text-white">Delivery Staff</span>
        </div>
