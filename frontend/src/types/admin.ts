...
/**
 * One color the Admin has added, with its own image gallery and its own per-size stock —
...
/** Shape the Admin Dashboard's product form works with — the store that owns the product is
