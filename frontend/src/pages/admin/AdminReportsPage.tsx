...
import { adminStatsService, revenueBySeller, paymentMethodBreakdown, totalRevenueOf } from '@/services/adminStatsService';
...
export function AdminReportsPage() {
  ...
  // jsPDF/xlsx (the export libraries) are heavy (~700KB) and only ever needed if the seller
  // actually clicks Export — dynamically imported per-click below instead of bundled into this
  // page's own chunk, so every visit to Reports doesn't pay for a PDF/Excel library it never uses.
